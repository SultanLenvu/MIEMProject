#include "BHGameExplosionEffect.h"
#include "Kismet/GameplayStatics.h"
#include "Sound/SoundCue.h"

ABHGameExplosionEffect::ABHGameExplosionEffect(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void ABHGameExplosionEffect::BeginPlay()
{
	Super::BeginPlay();
...
void ABHGameExplosionEffect::Tick(float DeltaSeconds)
{
