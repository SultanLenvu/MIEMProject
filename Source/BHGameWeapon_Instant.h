...
#include "BHGameWeapon_Instant.generated.h"

class ABHGameImpactEffect;
...
UCLASS(Abstract)
class ABHGameWeapon_Instant : public ABHGameWeapon
{
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, Category = Effects)
		TSubclassOf<ABHGameImpactEffect> ImpactTemplate;
