...
#include "BHGameTypes.h"
#include "GameFramework/Character.h"
#include "Sound/SoundCue.h"
#include "BHGameCharacter.generated.h"

DECLARE_MULTICAST_DELEGATE_TwoParams(FOnBHGameCharacterEquipWeapon, ABHGameCharacter*, ABHGameWeapon* /* new */);
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnBHGameCharacterUnEquipWeapon, ABHGameCharacter*, ABHGameWeapon* /* old */);

UCLASS(Abstract)
class ABHGameCharacter : public ACharacter
{
	...
	*/
	void AddWeapon(class ABHGameWeapon* Weapon);
	...
	*/
	void RemoveWeapon(class ABHGameWeapon* Weapon);
	...
	*/
	class ABHGameWeapon* FindWeapon(TSubclassOf<class ABHGameWeapon> WeaponClass);
	...
	*/
	void EquipWeapon(class ABHGameWeapon* Weapon);
	...
	*/
	class ABHGameWeapon* GetInventoryWeapon(int32 index) const;
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, Category = Inventory)
		TArray<TSubclassOf<class ABHGameWeapon> > DefaultInventoryClasses;

	/** weapons in inventory */
	UPROPERTY(Transient, Replicated)
		TArray<class ABHGameWeapon*> Inventory;

	/** currently equipped weapon */
	UPROPERTY(Transient, ReplicatedUsing = OnRep_CurrentWeapon)
		class ABHGameWeapon* CurrentWeapon;
...
protected:
	...
	void SetCurrentWeapon(class ABHGameWeapon* NewWeapon, class ABHGameWeapon* LastWeapon = NULL);

	/** current weapon rep handler */
	UFUNCTION()
		void OnRep_CurrentWeapon(class ABHGameWeapon* LastWeapon);
	...
	UFUNCTION(reliable, server, WithValidation)
		void ServerEquipWeapon(class ABHGameWeapon* NewWeapon);
